...
| Workflow | 時間（台灣） | 內容 |
|----------|--------------|------|
| `weekly_notify.yml` | 每週一 08:00 | CPI 通膨率（IMF）＋ 寶島光學科技 5312 股價/財務（Yahoo Finance） |
...
scripts/
  ...
  fetch_data.py      CPI（IMF/World Bank）、寶島 5312（yfinance）
...
- **寶島 5312 財報**：Yahoo Finance 對小型上櫃股的季報同步較慢，最新一季可能落後。
